...
// WEATHER MODAL: SHOWS ONLY THE CURRENT ACTIVE PHASE PERKS
function openWeatherModal() {
  ...
  if (gameState.isDay) {
    weatherModalBody.innerHTML = `
      <p style="text-align:center; font-size:16px; font-weight:900; color:#e6a100; margin-bottom:12px;">Phase: ☀️ Daytime (${formatTime(gameState.cycleTimeLeft)} left)</p>
    ...
    weatherModalBody.innerHTML = `
      <p style="text-align:center; font-size:16px; font-weight:900; color:#b388ff; margin-bottom:12px;">Phase: 🌙 Nighttime (${formatTime(gameState.cycleTimeLeft)} left)</p>
      <p><strong>⚡ Nocturnal Boost (2X Growth Speed):</strong><br>🍄 Glowshroom, 🍓 Strawberry</p>
    `;
  }
