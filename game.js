          ...
          gameState.fields.forEach(f => {
            f.forEach(p => {
              if (p.crop) {
                ...
                if (p.crop.isVine) {
                  if (!p.vineEstablished) {
                    p.progress += ((100 / (p.actualGrowTime || 10)) * sm) * offlineSeconds;
                    if (p.progress >= 100) {
                    ...
                    p.vineFruits.forEach(fr => {
                      if (!fr.isReady) {
                        fr.progress += ((100 / (fr.growTime || 10)) * sm) * offlineSeconds;
                        if (fr.progress >= 100) {
                          fr.progress = 100;
                          fr.isReady = true;
                        }
                  ...
                  p.progress += ((100 / (p.actualGrowTime || 5)) * sm) * offlineSeconds;
                  if (p.progress >= 100) {
                    p.progress = 100;
                    p.isReady = true;
                  }
